# Two-Body-Simulation
This project is a simulation of the two-body problem using the Euler Method and ROOT libraries for data analysis. While this method is known for its poor energy conservation, its use was specifically requested for this assignment.
